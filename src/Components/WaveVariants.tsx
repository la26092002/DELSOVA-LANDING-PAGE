...
export const SoftWaveSeparator: React.FC<{
  ...
  const wavePath = "M0,128L80,138.7C160,149,320,171,480,165.3C640,160,800,128,960,117.3C1120,107,1280,117,1360,122.7L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z";

  return (
    <div className={`w-full overflow-hidden ${heightClasses[height]} ${className}`}>
      <svg
...
export const DynamicWaveSeparator: React.FC<{
  ...
  const wavePath1 = "M0,160L60,170.7C120,181,240,203,360,192C480,181,600,139,720,138.7C840,139,960,181,1080,186.7C1200,192,1320,160,1380,144L1440,128L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z";
  const wavePath2 = "M0,192L60,202.7C120,213,240,235,360,224C480,213,600,171,720,170.7C840,171,960,213,1080,218.7C1200,224,1320,192,1380,176L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z";

  return (
    <div className={`w-full h-24 sm:h-32 relative overflow-hidden ${className}`}>
      <svg
        className={`w-full h-full absolute top-0 left-0 ${direction === 'down' ? 'rotate-180' : ''}`}
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <svg
        className={`w-full h-full absolute top-2 left-0 ${direction === 'down' ? 'rotate-180' : ''} opacity-70`}
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
...
export const TechWaveSeparator: React.FC<{
  ...
  return (
    <div className={`w-full h-20 sm:h-28 relative overflow-hidden ${className}`}>
      <svg
        className={`w-full h-full absolute top-0 left-0 ${direction === 'down' ? 'rotate-180' : ''}`}
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
...
export const DottedWaveSeparator: React.FC<{
  ...
  const wavePath = "M0,160L60,165.3C120,171,240,181,360,176C480,171,600,149,720,138.7C840,128,960,128,1080,138.7C1200,149,1320,171,1380,181.3L1440,192L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z";
  ...
  return (
    <div className={`w-full h-20 sm:h-28 relative overflow-hidden ${className}`}>
      ...
      >
        <defs>
          <pattern id="dotsPattern" x="0" y="0" width="15" height="15" patternUnits="userSpaceOnUse">
...
export const AsymmetricWaveSeparator: React.FC<{
  ...
  const wavePathLeft = `M0,${height}L80,${height-10}C160,${height-20},320,${height-40},480,${height-30}C640,${height-20},800,${height},960,${height-10}C1120,${height-20},1280,${height-40},1360,${height-50}L1440,${height-60}L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z`;
  
  const wavePathRight = `M0,${height-60}L80,${height-50}C160,${height-40},320,${height-20},480,${height-10}C640,${height},800,${height-20},960,${height-30}C1120,${height-40},1280,${height-20},1360,${height-10}L1440,${height}L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z`;
...
export const DeepWaveSeparator: React.FC<{
  ...
  const mainWave = "M0,128L48,138.7C96,149,192,171,288,170.7C384,171,480,149,576,144C672,139,768,149,864,154.7C960,160,1056,160,1152,149.3C1248,139,1344,117,1392,106.7L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z";
  
  const shadowWave = "M0,160L48,165.3C96,171,192,181,288,176C384,171,480,149,576,144C672,139,768,149,864,154.7C960,160,1056,160,1152,149.3C1248,139,1344,117,1392,106.7L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z";
  
  const highlightWave = "M0,96L48,106.7C96,117,192,139,288,138.7C384,139,480,117,576,112C672,107,768,117,864,122.7C960,128,1056,128,1152,117.3C1248,107,1344,85,1392,74.7L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z";

  return (
    <div className={`w-full h-28 sm:h-36 relative overflow-hidden ${className}`}>
      {/* Ombre */}
      <svg
        className={`w-full h-full absolute top-2 left-0 ${direction === 'down' ? 'rotate-180' : ''}`}
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Reflet */}
      <svg
        className={`w-full h-full absolute top-1 left-0 ${direction === 'down' ? 'rotate-180' : ''} opacity-60`}
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
...
export const PixelWaveSeparator: React.FC<{
  ...
  return (
    <div className={`w-full h-20 sm:h-28 relative overflow-hidden ${className}`}>
      ...
      >
        <defs>
          <pattern id="pixelPattern" x="0" y="0" width={size} height={size} patternUnits="userSpaceOnUse">
            <rect x="0" y="0" width={size} height={size} fill={color} fillOpacity="0.9" />
            <rect x={size/2} y={size/2} width={size/2} height={size/2} fill={color} fillOpacity="0.6" />
          </pattern>
        </defs>
        <path
          d={wavePath}
  ...
  return (
    <div className={`w-full h-24 sm:h-32 relative overflow-hidden ${className}`}>
      {wavePaths.map((path, index) => (
        <svg
          key={index}
          className={`w-full h-full absolute top-0 left-0 ${direction === 'down' ? 'rotate-180' : ''} ${animated ? 'animate-float' : ''}`}
          style={{
