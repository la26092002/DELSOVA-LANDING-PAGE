...
import { Mail, Facebook, Instagram, Linkedin, Music2, Phone } from "lucide-react";
import logo from "../assets/Group 150.png";

const Footer: React.FC = () => {
  return (
    <footer className="relative w-full bg-[#FBFBFB] overflow-hidden text-gray-900 pt-8">
      {/* ===== Wave Container ===== */}
      ...
      {/* ===== Footer Content ===== */}
      <div className="relative z-20 bg-[#CBED00] px-6 lg:px-16 py-8 lg:py-12">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/4 space-y-4">
            <img
              src={logo}
              alt="Dtour Logo"
              className="w-48 lg:w-56 h-12 lg:h-16 object-contain"
            />
            <div className="text-lime-800 text-sm lg:text-base font-medium font-['Poppins'] leading-6 lg:leading-7">
              Dtour est une application innovante qui te permet de réserver ton
              passage à l'avance, d'organiser ton temps et d'éviter les longues
              files d'attente dans les centres et les institutions.
            </div>
          </div>

          {/* === Center Section Contact === */}
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start space-y-4">
            <div className="text-lime-800 text-xl lg:text-2xl font-extrabold font-['Poppins']">
              Contact-nous
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <Mail size={20} color="#CBED00" />
              </div>
              <div className="text-lime-800 text-base font-medium font-['Poppins']">
                ridha.boceiri@gmail.com
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <Phone size={20} color="#CBED00" />
              </div>
              <div className="text-lime-800 text-base font-medium font-['Poppins']">
                +213 541 400 555
              </div>
          ...
          <div className="w-full lg:w-1/4 flex flex-col items-center lg:items-start space-y-4">
            ...
            <div className="flex space-x-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-100 transition">
                <Facebook size={20} color="#CBED00" />
              </div>
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-100 transition">
                <Instagram size={20} color="#CBED00" />
              </div>
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-100 transition">
                <Music2 size={20} color="#CBED00" />
              </div>
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-100 transition">
                <Linkedin size={20} color="#CBED00" />
              </div>
            </div>
          </div>
        </div>
        ...
        {/* ===== Footer bottom text ===== */}
        <div className="max-w-7xl mx-auto mt-8 lg:mt-12 pt-6 border-t border-lime-700/30">
          <div className="text-lime-800 text-center text-lg lg:text-xl font-semibold font-['Poppins']">
